...
QString RadioInterface::footText () {
	version			= QString (CURRENT_VERSION);
        QString versionText = "sdrplayDab- version: " + QString(CURRENT_VERSION);
