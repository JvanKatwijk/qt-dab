...
#	   ../includes/support/Xtan2.h \
	   ...
	   ./devices-sdrplayDab/device-handler.h 
...
#	   ../src/support/Xtan2.cpp \
	   ...
	   ./devices-sdrplayDab/device-handler.cpp 
#
#
unix {
DESTDIR		= ./linux-bin
...
sdrplay-v2   	{
DEPENDPATH	+= ./devices-sdrplayDab/sdrplay-handler-v2 
INCLUDEPATH	+= ./devices-sdrplayDab/sdrplay-handler-v2 
HEADERS		+= ./devices-sdrplayDab/sdrplay-handler-v2/sdrplay-handler.h \
	           ./devices-sdrplayDab/sdrplay-handler-v2/sdrplayselect.h 
SOURCES		+= ./devices-sdrplayDab/sdrplay-handler-v2/sdrplay-handler.cpp \
	           ./devices-sdrplayDab/sdrplay-handler-v2/sdrplayselect.cpp 
FORMS		+= ./devices-sdrplayDab/sdrplay-widget.ui
DEFINES		+= SDRPLAY_V2
}
