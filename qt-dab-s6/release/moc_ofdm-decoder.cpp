...
QT_MOC_LITERAL(3, 20, 11) // "showQuality"

    },
    "ofdmDecoder\0showIQ\0\0showQuality"
};
...
void ofdmDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showQuality((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ofdmDecoder::showQuality)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ofdmDecoder::showQuality(float _t1, float _t2, float _t3)
{
