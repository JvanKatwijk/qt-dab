...
void mp2Processor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->newAudio((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (mp2Processor::*)(int , int );
...
// SIGNAL 1
void mp2Processor::newAudio(int _t1, int _t2)
{
