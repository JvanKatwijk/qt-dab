...
struct qt_meta_stringdata_smallSpinBox_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_smallSpinBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_smallSpinBox_t qt_meta_stringdata_smallSpinBox = {
    {
QT_MOC_LITERAL(0, 0, 12) // "smallSpinBox"
...
static const uint qt_meta_data_smallSpinBox[] = {
...
QT_INIT_METAOBJECT const QMetaObject smallSpinBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QSpinBox::staticMetaObject>(),
    qt_meta_stringdata_smallSpinBox.data,
    qt_meta_data_smallSpinBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *smallSpinBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_smallSpinBox.stringdata0))
