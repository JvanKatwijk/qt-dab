/****************************************************************************
** Meta object code from reading C++ file 'color-selector.h'
**
...
#include <memory>
#include "../../includes/support/color-selector.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'color-selector.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 12), // "select_color"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11) // "QModelIndex"

    },
    "colorSelector\0select_color\0\0QModelIndex"
};
...
void colorSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->select_color((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
