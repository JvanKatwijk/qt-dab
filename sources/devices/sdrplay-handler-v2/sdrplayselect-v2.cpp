...
//	to the computer, the user is asked to make a choice.
	...
	sdrplaySelect_v2::sdrplaySelect_v2	() {
	...
	connect (selectorDisplay, &QListView::clicked,
	         this, &sdrplaySelect_v2::select_rsp);
	selectedItem	= -1;
}
...
void	sdrplaySelect_v2::addtoList (const char *v) {
QString s (v);
...
void	sdrplaySelect_v2::select_rsp (QModelIndex s) {
	QDialog::done (s. row());
}
