...
struct qt_meta_stringdata_mapPortHandler_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mapPortHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mapPortHandler_t qt_meta_stringdata_mapPortHandler = {
    {
QT_MOC_LITERAL(0, 0, 14), // "mapPortHandler"
QT_MOC_LITERAL(1, 15, 19), // "handle_acceptButton"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "mapPortHandler\0handle_acceptButton\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mapPortHandler[] = {
...
QT_INIT_METAOBJECT const QMetaObject mapPortHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_mapPortHandler.data,
    qt_meta_data_mapPortHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mapPortHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mapPortHandler.stringdata0))
