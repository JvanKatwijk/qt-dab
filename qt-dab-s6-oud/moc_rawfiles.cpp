...
#include <memory>
#include "../qt-devices/rawfiles-new/rawfiles.h"
...
struct qt_meta_stringdata_rawFiles_t {
    QByteArrayData data[3];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rawFiles_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rawFiles_t qt_meta_stringdata_rawFiles = {
    {
QT_MOC_LITERAL(0, 0, 8), // "rawFiles"
QT_MOC_LITERAL(1, 9, 11), // "setProgress"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "rawFiles\0setProgress\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_rawFiles[] = {
...
QT_INIT_METAOBJECT const QMetaObject rawFiles::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_rawFiles.data,
    qt_meta_data_rawFiles,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *rawFiles::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rawFiles.stringdata0))
