...
public:
    ...
    void setupUi(QWidget *sdrplayWidget_v3)
    {
        ...
        sdrplayWidget_v3->resize(408, 266);
...
#if QT_CONFIG(tooltip)
        ppmControl->setToolTip(QCoreApplication::translate("sdrplayWidget_v3", "<html><head/><body><p>ppm control. Tells the device the offset (in ppm) of the observed oscillator offset.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        label->setText(QCoreApplication::translate("sdrplayWidget_v3", "ppm control", nullptr));
