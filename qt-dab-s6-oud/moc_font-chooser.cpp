...
QT_MOC_LITERAL(1, 12, 11), // "select_font"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11) // "QModelIndex"

    },
    "fontChooser\0select_font\0\0QModelIndex"
};
...
void fontChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->select_font((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject fontChooser::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_fontChooser.data,
    qt_meta_data_fontChooser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
