...
struct qt_meta_stringdata_normalPushButton_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_normalPushButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_normalPushButton_t qt_meta_stringdata_normalPushButton = {
    {
QT_MOC_LITERAL(0, 0, 16), // "normalPushButton"
QT_MOC_LITERAL(1, 17, 12), // "rightClicked"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "normalPushButton\0rightClicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_normalPushButton[] = {
...
void normalPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (normalPushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&normalPushButton::rightClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject normalPushButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_meta_stringdata_normalPushButton.data,
    qt_meta_data_normalPushButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *normalPushButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_normalPushButton.stringdata0))
