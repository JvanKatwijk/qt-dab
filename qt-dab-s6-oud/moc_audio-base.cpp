/****************************************************************************
** Meta object code from reading C++ file 'audio-base.h'
**
...
#include <memory>
#include "../includes/output/audio-base.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'audio-base.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject audioBase::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_audioBase.data,
    qt_meta_data_audioBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
