...
struct qt_meta_stringdata_presetComboBox_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_presetComboBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_presetComboBox_t qt_meta_stringdata_presetComboBox = {
    {
QT_MOC_LITERAL(0, 0, 14) // "presetComboBox"
...
static const uint qt_meta_data_presetComboBox[] = {
...
QT_INIT_METAOBJECT const QMetaObject presetComboBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QComboBox::staticMetaObject>(),
    qt_meta_stringdata_presetComboBox.data,
    qt_meta_data_presetComboBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *presetComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_presetComboBox.stringdata0))
