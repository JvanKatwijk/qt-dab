...
QT_MOC_LITERAL(1, 11, 10), // "show_label"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16) // "show_mothandling"

    },
    "padHandler\0show_label\0\0show_mothandling"
};
...
void padHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->show_label((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (padHandler::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&padHandler::show_label)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject padHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_padHandler.data,
    qt_meta_data_padHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
