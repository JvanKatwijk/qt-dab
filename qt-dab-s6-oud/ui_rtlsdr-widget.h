...
public:
    ...
    void setupUi(QWidget *dabstickWidget)
    {
        ...
        biasControl->setObjectName(QString::fromUtf8("biasControl"));
        ...
        xml_dumpButton->setObjectName(QString::fromUtf8("xml_dumpButton"));

        verticalLayout->addWidget(xml_dumpButton);

        iq_dumpButton = new QPushButton(dabstickWidget);
        iq_dumpButton->setObjectName(QString::fromUtf8("iq_dumpButton"));
