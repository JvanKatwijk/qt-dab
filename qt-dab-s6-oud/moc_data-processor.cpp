...
QT_MOC_LITERAL(1, 14, 14), // "show_mscErrors"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "dataProcessor\0show_mscErrors\0"
};
...
void dataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->show_mscErrors((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataProcessor::show_mscErrors)) {
                *result = 0;
                return;
            }
        }
