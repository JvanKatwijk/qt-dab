...
#endif
#ifdef	HAVE_COLIBRI
	configWidget. deviceSelector	-> addItem ("colibri");
#endif
#ifdef	HAVE_SOAPY
...
#endif
	   try {
	      inputDevice_p	= new sdrplayHandler_v2 (dabSettings_p,
	                                                 version);
	   }
...
//	RTL_TCP might be working. 
	...
	if (s == "uhd") {
	   try {
	      inputDevice_p = new uhdHandler (dabSettings_p);
	   }
	   catch (...) {
	      QMessageBox::warning (this, tr ("Warning"),
	                           tr ("uhd: no luck\n") );
	...
	if (s == "colibri") {
	   try {
	      inputDevice_p = new colibriHandler (dabSettings_p);
	   }
	   catch (...) {
	      QMessageBox::warning (this, tr ("Warning"),
	                           tr ("colibri: no luck\n") );
...
//	ensemb le display has one of two effects
