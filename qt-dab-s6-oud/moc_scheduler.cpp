...
QT_MOC_LITERAL(3, 19, 9), // "removeRow"
QT_MOC_LITERAL(4, 29, 14) // "handle_timeOut"

    },
    "Scheduler\0timeOut\0\0removeRow\0"
    "handle_timeOut"
};
...
void Scheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->timeOut((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->removeRow((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Scheduler::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scheduler::timeOut)) {
                *result = 0;
                return;
            }
        }
