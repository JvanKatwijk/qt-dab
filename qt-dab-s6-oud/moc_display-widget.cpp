...
#include <memory>
#include "forms-v6/new-display/display-widget.h"
...
QT_MOC_LITERAL(1, 14, 10), // "mouseClick"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 10), // "switch_tab"
QT_MOC_LITERAL(4, 37, 15) // "rightMouseClick"

    },
    "displayWidget\0mouseClick\0\0switch_tab\0"
    "rightMouseClick"
};
...
void displayWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->switch_tab((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->rightMouseClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (displayWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&displayWidget::mouseClick)) {
                *result = 0;
                return;
            }
        }
