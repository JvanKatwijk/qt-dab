...
#include <memory>
#include "../qt-devices/xml-filereader/xml-filereader.h"
...
struct qt_meta_stringdata_xml_fileReader_t {
    QByteArrayData data[4];
    char stringdata0[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_xml_fileReader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_xml_fileReader_t qt_meta_stringdata_xml_fileReader = {
    {
QT_MOC_LITERAL(0, 0, 14), // "xml_fileReader"
QT_MOC_LITERAL(1, 15, 11), // "setProgress"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 23) // "handle_continuousButton"

    },
    "xml_fileReader\0setProgress\0\0"
    "handle_continuousButton"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_xml_fileReader[] = {
...
QT_INIT_METAOBJECT const QMetaObject xml_fileReader::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_xml_fileReader.data,
    qt_meta_data_xml_fileReader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *xml_fileReader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_xml_fileReader.stringdata0))
