...
struct qt_meta_stringdata_smallComboBox_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_smallComboBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_smallComboBox_t qt_meta_stringdata_smallComboBox = {
    {
QT_MOC_LITERAL(0, 0, 13) // "smallComboBox"
...
static const uint qt_meta_data_smallComboBox[] = {
...
QT_INIT_METAOBJECT const QMetaObject smallComboBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QComboBox::staticMetaObject>(),
    qt_meta_stringdata_smallComboBox.data,
    qt_meta_data_smallComboBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *smallComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_smallComboBox.stringdata0))
