...
public:
    ...
    void setupUi(QWidget *snrWidget)
    {
        ...
        snrSlider->setObjectName("snrSlider");
        ...
        snrDumpButton->setObjectName("snrDumpButton");

        horizontalLayout_2->addWidget(snrDumpButton);

        snrCompressionSelector = new QSpinBox(snrWidget);
        snrCompressionSelector->setObjectName("snrCompressionSelector");
        ...
        snrLengthSelector->setObjectName("snrLengthSelector");
