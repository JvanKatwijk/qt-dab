...
public:
    ...
    void setupUi(QWidget *hackrfWidget)
    {
        if (hackrfWidget->objectName().isEmpty())
            hackrfWidget->setObjectName("hackrfWidget");
        ...
        usb_board_id_display->setObjectName("usb_board_id_display");
        ...
        vgagainDisplay->setObjectName("vgagainDisplay");
        ...
        vgaGainSlider->setObjectName("vgaGainSlider");
        ...
        lnagainDisplay->setObjectName("lnagainDisplay");
        ...
        lnaGainSlider->setObjectName("lnaGainSlider");
